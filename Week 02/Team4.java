...
public class Team4 extends JPanel{
    ...
    public Team4() throws IOException, JSONException {    // constructor
        basePlate();
        mapPlate();
        weatherPlate();
...
private JPanel weatherPlate() throws IOException, JSONException{
    //JPanel weatherPanel = new JPanel();
    weatherPanel.setLayout(new GridLayout(5,1));
    ...
    Font titleFont = new Font("Serif", Font.BOLD + Font.ITALIC, 10);
    ...
    this.ta4.setText("Wind: " + String.valueOf(windVelocity) + " mph" + " at " + String.valueOf(windDirection) + "°");
    this.ta5.setText("Pressure: " + String.valueOf(atmosPressure) + " hPa");
